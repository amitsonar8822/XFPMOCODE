...
projectNumbersListDF['number'] = mdf['number']
...
mdf.to_csv(r'%s/intermediaryFiles/serviceNowAPI/PPM/ProjectsData_full.csv' % firstarg
           , index=False, header=True)

projectNumbersListDF.to_csv(r'%s/intermediaryFiles/serviceNowAPI/PPM/ProjectsFull_list.csv' % firstarg
                            , index=False, header=True)

# mdf.to_csv(r'C:\workdocs\PMO\API_RESPONSE/ProjectsData_full.csv'
#           , index=False, header=True)
